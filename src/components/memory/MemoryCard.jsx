...
// 兩種狀態：已記錄回憶（顯示照片+心情）/ 尚未（顯示占位邀請）
export function MemoryCard({ event, onOpen }) {
  ...
  return (
    <Card
      ...
      className={cn(
        'cursor-pointer overflow-hidden transition-all duration-300 ease-out hover:shadow-zen-lg group',
      )}
    >
      {hasMemory ? (
        <>
